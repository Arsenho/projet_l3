...
public class NotificationController implements Serializable {
    ...
    @EJB
    private com.oapet.jsf.sessionbean.NotificationFacade ejbFacade;
    ...
    @FacesConverter(value = "notificationConverter")
    public static class NotificationControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Notification) {
                ...
                return getStringKey(o.getIdNotification());
            } else {
