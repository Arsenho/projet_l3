...
import com.oapet.jsf.sessionbean.FiliereFacade;
...
public class FiliereController implements Serializable {
    ...
    @EJB
    private com.oapet.jsf.sessionbean.FiliereFacade ejbFacade;
    ...
    public List<String> getListeNiveau() {
        return listeNiveau;
    }

    public void setListeNiveau(List<String> listeNiveau) {
        ...
        if (selected != null) {
            ...
            try {
                if (persistAction != PersistAction.DELETE) {
                   for (String  niveau: this.listeNiveau) {
                        selected.setNiveauFiliere(niveau);
