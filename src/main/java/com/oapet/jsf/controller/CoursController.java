...
import com.oapet.jsf.sessionbean.CoursFacade;
...
public class CoursController implements Serializable {
    ...
    @EJB
    private com.oapet.jsf.sessionbean.CoursFacade ejbFacade;
    ...
    public Cours getCours(java.lang.String id) {
    ...
    public static class CoursControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Cours) {
                ...
                return getStringKey(o.getCodeCours());
            } else {
