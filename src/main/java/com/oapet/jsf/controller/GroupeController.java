...
public class GroupeController implements Serializable {
    ...
    @EJB
    private com.oapet.jsf.sessionbean.GroupeFacade ejbFacade;
    ...
    public Groupe getGroupe(java.lang.String id) {
    ...
    public static class GroupeControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Groupe) {
                ...
                return getStringKey(o.getNomGroupe());
            } else {
