...
import com.oapet.jsf.sessionbean.EnseignantFacade;
...
public class EnseignantController implements Serializable {
    ...
    @EJB
    private com.oapet.jsf.sessionbean.EnseignantFacade ejbFacade;
    ...
    public Enseignant getEnseignant(java.lang.Integer id) {
    ...
    public static class EnseignantControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Enseignant) {
                ...
                return getStringKey(o.getIdEnseignant());
            } else {
